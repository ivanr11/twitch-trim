...
export default function Home() {
	...
	return (
		<main className="min-h-screen flex flex-col bg-[#424549] relative">
				...
				<div className="mb-8 flex flex-col justify-center items-center">
					<div className="w-3/4 mb-8">
						...
						<p>
							...
							choose your desired category, select the number of clips you want
							to include, and let our intelligent algorithms do the rest.
							TwitchTrim carefully curates and edits the clips, crafting a
							polished and entertaining video that captures the essence of
							Twitch action, saving you valuable time and effort.
						</p>
					</div>
					...
					<div className="w-3/4 mb-8">
						<p>
							...
							Twitch experiences with the world and growing your online
							presence.
						</p>
					</div>
					...
					{showWarning && (
						<div className="w-3/4 bg-yellow-100 border-l-4 border-yellow-500 p-2 mt-4 text-sm text-yellow-700 relative">
							<p className="pr-4">
								...
								currently pending verification. You can safely proceed by
								clicking &quot;Advanced&quot; and then &quot;Go to railway.app
								(unsafe)&quot;.
							</p>
							<button
			...
			<footer className="w-full py-4 text-center text-gray-300 text-sm bg-[#424549] fixed bottom-0">
				<div className="max-w-4xl mx-auto">
